...
public class MonIndicator extends View {
    ...
    private int[] colors = new
            int[]{0xFF942909, 0xFF577B8C, 0xFF201289, 0xFF7E207C, 0xFF38B549};
    ...
    public MonIndicator(Context context, AttributeSet attrs) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.monindicator_circleRadius,
                paramsCreator.getDefaultCircleRadius());

        circleSpacing = (int) a.getDimension(R.styleable.monindicator_circleSpacing,
                paramsCreator.getDefaultCircleSpacing());
    ...
    private void drawCircle01(Canvas canvas) {
        ...
        wrapper.dynamicDiameter = wrapper.dynamicDiameter
                + wrapper.orientation * this.increment;
        ...
        int totalWidth = this.circleRadius * 2 * this.wrappers.size()
                + (this.wrappers.size() - 1) * this.circleSpacing;

        int centerX = this.getWidth() / 2 - totalWidth / 2
                + this.circleRadius;
    ...
    private void drawCircle02(Canvas canvas) {
        ...
        int centerX = this.getWidth() / 2 - totalWidth / 2
                + (wrapper.diameter + this.circleSpacing) * 1
                + this.circleRadius;
        int centerY = this.getHeight() / 2;
    ...
    private void drawCircle03(Canvas canvas) {
        ...
        int centerX = this.getWidth() / 2 - totalWidth / 2
                + (wrapper.diameter + this.circleSpacing) * 2
                + this.circleRadius;
    ...
    private void drawCircle04(Canvas canvas) {
        ...
        int centerX = this.getWidth() / 2 - totalWidth / 2
                + (wrapper.diameter + this.circleSpacing) * 3
                + this.circleRadius;
    ...
    private void drawCircle05(Canvas canvas) {
        ...
        int centerX = this.getWidth() / 2 - totalWidth / 2
                + (wrapper.diameter + this.circleSpacing) * 4
                + this.circleRadius;
