...
public class Web_Github extends AppCompatActivity {

    private static final String TAG = "Web_Github";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_github);
    ...
    private void initView() {
        ...
        webView.loadUrl("https://github.com/HankinsPan");
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view,
                ...
                ShowToast.ColorToast(Web_Github.this, message, 1200);
