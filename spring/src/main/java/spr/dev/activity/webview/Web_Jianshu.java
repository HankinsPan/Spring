...
public class Web_Jianshu extends AppCompatActivity {

    private static final String TAG = "Web_Jianshu";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_jianshu);
    ...
    private void initView() {
        webView = (WebView) findViewById(R.id.web_jianshu);
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view,
                ...
                ShowToast.ColorToast(Web_Jianshu.this, message, 1200);
