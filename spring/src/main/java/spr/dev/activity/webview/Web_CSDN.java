...
public class Web_CSDN extends AppCompatActivity {

    private static final String TAG = "Web_CSDN";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_csdn);
    ...
    private void initView() {
        webView = (WebView) findViewById(R.id.web_csdn);
        ...
        webView.loadUrl("http://blog.csdn.net/hankins_pan");
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view,
                ...
                ShowToast.ColorToast(Web_CSDN.this, message, 1200);
