...
public class Web_ThirdPary extends AppCompatActivity {

    private static final String TAG = "Web_ThirdPary";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_thirdparty);
    ...
    private void initView() {
        webView = (WebView) findViewById(R.id.web_third);
        ...
        webView.loadUrl("https://leancloud.cn/");
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view,
                ...
                ShowToast.ColorToast(Web_ThirdPary.this, message, 1200);
