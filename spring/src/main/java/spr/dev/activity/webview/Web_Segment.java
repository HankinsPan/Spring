...
public class Web_Segment extends AppCompatActivity {

    private static final String TAG = "Web_Segment";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_segment);
    ...
    private void initView() {
        webView = (WebView) findViewById(R.id.web_segmentfault);
        ...
        webView.loadUrl("https://segmentfault.com/u/hankins_pan");
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view,
                ...
                ShowToast.ColorToast(Web_Segment.this, message, 1200);
